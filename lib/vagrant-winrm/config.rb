...
module VagrantPlugins
  module WINRM
    class Config < Vagrant.plugin("2", :config)
      # The username for WINRM.
      #
      # @return [String]
      attr_accessor :winrm_username

      # The password for WINRM.
      #
      # @return [String]
      attr_accessor :winrm_password

      # The guest_port for WINRM.
      #
      # @return [String]
      attr_accessor :winrm_guest_port
      ...
      # The name of the WINRM region in which to create the instance.
      #
      # @return [String]
      ...
      # The version of the WINRM api to use
      #
      # @return [String]
      attr_accessor :version

      # The secret access key for accessing WINRM.
      #
      # @return [String]
      ...
      #
      #     winrm.region_config "us-east-1" do |region|
      ...
      # @yield [config] Yields a new WINRM configuration.
      ...
      def finalize!
        ...
        # Default region is us-east-1. This is sensible because WINRM
      ...
      def validate(machine)
        ...
        errors << I18n.t("vagrant_winrm.config.region_required") if @region.nil?
        ...
        if @region
          ...
          errors << I18n.t("vagrant_winrm.config.access_key_id_required") if \
            config.access_key_id.nil?
          errors << I18n.t("vagrant_winrm.config.secret_access_key_required") if \
            config.secret_access_key.nil?
          errors << I18n.t("vagrant_winrm.config.ami_required") if config.ami.nil?

          if config.ssh_private_key_path && \
            !File.file?(File.expand_path(config.ssh_private_key_path, machine.env.root_path))
            errors << I18n.t("vagrant_winrm.config.private_key_missing")
          end
        end

        { "WINRM Provider" => errors }
      end
